...
def func1(t):   #가정상 t 로 list가 넘어올 것을 기대
    t[0] *=2
...
#함수 연수는 필요한 개수만큼 만들 수 있다

#기본값을 미리 선언해 둘 수 있다.

def incr(a,step=1):     #두 번쨰 인자를 넘기지 않으면 1값이 기본으로 사용된다
    return a+step

a=10

print(incr(a))  # stap은 기본값 1로사용
...
#print(f(10,20,30,40,option=1,option=2))     #option1,option2는 키워드 인수
